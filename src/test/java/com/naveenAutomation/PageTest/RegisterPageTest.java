...
public class RegisterPageTest extends TestBase {
	...
	SuccessPage successRegisterPage;
	...
	public void validateWarningMsgIfFirstNameCharExceedsRange() {
		...
		successRegisterPage = registerPage.clickContinueButton();
	...
	@Test
	public void validateWarningMsgWithInvalidEmail() {
		registerPage = loginPage.continueToRegisterClick();
		registerPage.fillingRegistrationForm("Harry", "Sharma", "ha", "123456789", "Harry1234", "Harry1234");
		registerPage.clickPolicyCheckBox();
		successRegisterPage = registerPage.clickContinueButton();
		Assert.assertEquals(registerPage.invalidEmailWarningText(), "E-Mail Address does not appear to be valid!",
				"Registration successfull");
	}
